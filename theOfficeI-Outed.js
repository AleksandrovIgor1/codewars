...
const outed = (meet, boss) => {
	...
	let overallHappinessRating = 0;
	meet[boss] = meet[boss] * 2;
	Object.keys(meet).map(item => overallHappinessRating += meet[item]);
	return overallHappinessRating / size <= 5 ? 'Get Out Now!' : 'Nice Work Champ!';
};
